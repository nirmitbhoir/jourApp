...
import net.engdigest.jourApp.Service.UserDetailsServiceImpl;
...
public class UserDetailsServiceImpltest {
    ...
    @Mock //create a fake (dummy) object for testing instead of using the real object.
            //It does not check in database it just test the method
